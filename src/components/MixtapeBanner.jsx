  ...
  return (
    <section className=''>
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center space-y-10 md:space-y-0 md:space-x-12 relative z-10">
        ...
        <div className="relative flex-shrink-0 w-full md:w-1/2 lg:w-1/3 group animate-scaleIn">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6 w-full md:w-1/2 animate-slideInRight">
